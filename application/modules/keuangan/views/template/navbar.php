		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <a href="<?= base_url('keuangan/Auth/logout'); ?>" class="dropdown-item">Logout</a>
            ...
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="<?= base_url('keuangan/Akademik'); ?>">
                  ...
                  <a class="dropdown-item" href="<?= base_url('keuangan/Akademik/cari'); ?>">
               ...
               <li class="nav-item">
                ...
                <a class="nav-link" href="<?= base_url('keuangan/Jenis_pembayaran'); ?>" >
               ...
               <li class="nav-item">
                ...
                <a class="nav-link" href="<?= base_url('keuangan/Pembayaran_Spp'); ?>" >
