    ...
    tampil();
      ...
      $('#cari').on('click',function(){
         ...
         $.ajax({
          ...
          url :"<?= base_url('keuangan/Akademik/ajax_getSiswaByNama');?>",
          method : "POST",
          dataType : "JSON",
      ...
      function cetak(){
          ...
          window.open ("<?= base_url('keuangan/Akademik/cetak_pd_all/');?>"+"_blank");
      ...
      function export_all(){
          ...
          window.open ("<?= base_url('keuangan/Akademik/export_pd_all/');?>"+"_blank");
    }
