  ...
  <script>
      ...
      $('#tingkat').change(function(){
        ...
        $.ajax({
          ...
          Type : "post",
          url :"<?= base_url('keuangan/Akademik/ajax_getKelas/');?>"+id,
          dataType : "JSON",
      ...
      $('#kelas').change(function(){
         ...
         $.ajax({
          ...
          Type : "POST",
          url :"<?= base_url('keuangan/Akademik/ajax_getSiswaByKelas/');?>"+id_kelas,
          dataType : "JSON",
      ...
      function view(nis){
         ...
         $.get("<?= base_url('keuangan/Akademik/view/');?>"+nis, {}, function(data, status){
      ...
      function cetak(){
        ...
        if (id_kelas == null) {
          ...
          window.open ("<?= base_url('keuangan/Akademik/cetak_perkelas/');?>"+id_kelas, "_blank");
        }
      }

       function print(nis){

          window.open ("<?= base_url('keuangan/Akademik/cetak_pd/');?>"+nis, "_blank");
