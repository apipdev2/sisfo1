  ...
  <script>
      ...
      $('#tingkat').change(function(){
        ...
        $.ajax({
          ...
          Type : "post",
          url :"<?= base_url('bpbk/Akademik/ajax_getKelas/');?>"+id,
          dataType : "JSON",
      ...
      $('#kelas').change(function(){
         ...
         $.ajax({
          ...
          Type : "POST",
          url :"<?= base_url('bpbk/Akademik/ajax_getSiswaByKelas/');?>"+id_kelas,
          dataType : "JSON",
      ...
      function view(nis){
         ...
         $.get("<?= base_url('bpbk/Akademik/view/');?>"+nis, {}, function(data, status){
      ...
      function cetak(){
        ...
        if (id_kelas == null) {
          ...
          window.open ("<?= base_url('bpbk/Akademik/cetak_perkelas/');?>"+id_kelas, "_blank");
        }
      }
