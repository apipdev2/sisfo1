		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <a href="<?= base_url('bpbk/Auth/logout'); ?>" class="dropdown-item">Logout</a>
          ...
          <div class="collapse navbar-collapse" id="navbar-menu">
            ...
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item">
                ...
                <a class="nav-link" href="<?= base_url('bpbk/Dashboard'); ?>" >
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="<?= base_url('bpbk/Akademik'); ?>">
                  ...
                  <a class="dropdown-item" href="<?= base_url('bpbk/Akademik/cari'); ?>">
               ...
               <li class="nav-item">
                ...
                <a class="nav-link" href="<?= base_url('bpbk/Kategori_pelanggaran'); ?>" >
               ...
               <li class="nav-item">
                ...
                <a class="nav-link" href="<?= base_url('bpbk/Jenis_pelanggaran'); ?>" >
               ...
               <li class="nav-item">
                ...
                <a class="nav-link" href="<?= base_url('bpbk/Pelanggaran'); ?>" >
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">       
                  ...
                  <a class="dropdown-item" href="<?= base_url('keuangan/ChangePassword'); ?>">
