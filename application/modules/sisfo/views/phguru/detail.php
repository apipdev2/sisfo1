  ...
  <div class="modal modal-blur fade" id="modal-edit<?= $row->id_presensi;?>" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <form action="<?= base_url('sisfo/Presensiguru/edit/'); ?>" method="post">
          <div class="modal-body">
              ...
              <table width="100%">
                <tr>
                  <th>Nama</th><th>:</th><th><?= $row->nama_lengkap; ?></th>
                </tr>
                <tr>
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="<?= base_url('sisfo/Presensiguru/hapus/'.encrypt_url($row->id_presensi )); ?>" class="btn btn-danger" >Yes, Delete data</a>
          </div>
        </div>
      </div>
    </div>
