  ...
  <script>
      ...
      $('#tingkat').change(function(){
        ...
        $.ajax({
          ...
          Type : "post",
          url :"<?= base_url('infoguru/Akademik/ajax_getKelas/');?>"+id,
          dataType : "JSON",
      ...
      $('#kelas').change(function(){
         ...
         $.ajax({
          ...
          Type : "POST",
          url :"<?= base_url('infoguru/Akademik/ajax_getSiswaByKelas/');?>"+id_kelas,
          dataType : "JSON",
          ...
          console.log(data);      
            ...
            for (var i = 0; i < data.length; i++) {
              ...
              html+='<tr>'
                   ...
                   +'<td>'+tanggal_lahir+'</td>'
                   +'<td>'+data[i].kelas+'</td>'
                   +'<td><a href="#" onClick="view('+data[i].nis+')" class="fas fa-search text-info"></a> | <a href="<?= base_url();?>infoguru/Akademik/edit/'+data[i].id_siswa+'" class="fas fa-edit text-warning"></a> | <a href="#" onClick="print('+data[i].nis+')" class="fas fa-print text-secondary"></a></td>'
                   +'</tr>';
            }
      ...
      function view(nis){
         ...
         $.get("<?= base_url('infoguru/Akademik/view/');?>"+nis, {}, function(data, status){
      ...
      function cetak(){
        ...
        if (id_kelas == null) {
          ...
          window.open ("<?= base_url('infoguru/Akademik/cetak_perkelas/');?>"+id_kelas, "_blank");
        }
      }

       function print(nis){

          window.open ("<?= base_url('infoguru/Akademik/cetak_pd/');?>"+nis, "_blank");
