    ...
    tampil();
      ...
      $('#cari').on('click',function(){
         ...
         $.ajax({
          ...
          url :"<?= base_url('infoguru/Akademik/ajax_getSiswaByNama');?>",
          method : "POST",
          dataType : "JSON",
      ...
      function tampil(){
         $.ajax({
          ...
          url :"<?= base_url('infoguru/Akademik/ajax_getSiswa');?>",
          Type : "get",
          dataType : "JSON",
          success:function(data){       
            var no=0;
      ...
      function cetak(){
          ...
          window.open ("<?= base_url('infoguru/Akademik/cetak_pd_all/');?>"+"_blank");
      ...
      function export_all(){
          ...
          window.open ("<?= base_url('infoguru/Akademik/export_pd_all/');?>"+"_blank");
